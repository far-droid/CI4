...
class KategoriServersideModel extends Model
{
    // Property yang dibutuhkan
    protected $table = "tbl_kategori";
    protected $column_order = [null, 'id_kategori', 'nama_kategori', null];
    protected $column_search = ['nama_kategori'];
    protected $order = ['nama_kategori' => 'asc'];
    protected $request;
    protected $model;
    ...
    private function _get_datatables_query()
    {
        ...
        $this->model = $this->table($this->table)->select('id_kategori, nama_kategori');
