...
class ProdukServersideModel extends Model
{
    // Property yang dibutuhkan
    protected $table = "tbl_produk";
    protected $column_order = [null, 'id_produk', 'id_kategori-p', 'nama_produk', 'kode_produk', 'foto_produk', 'tgl_register', null];
    protected $column_search = ['id_kategori-p', 'nama_produk', 'kode_produk', 'foto_produk', 'tgl_register'];
    protected $order = ['id_produk' => 'asc'];
    protected $request;
    protected $model;
    ...
    private function _get_datatables_query()
    {
        ...
        $this->model = $this->table($this->table)->select('id_produk, id_kategori-p, nama_produk, kode_produk, foto_produk, tgl_register')->join('tbl_kategori', 'tbl_kategori.id_kategori = tbl_produk.id_kategori-p');
        ...
        // Jika tidak ada request pengurutan maka akan diurutkan sesuai id_kategori
